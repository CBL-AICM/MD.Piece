...
(function () {
  const DICT = {
    'zh-TW': {
      ...
      'onb.s5.desc': '在情緒輪上拖到你現在的位置：中央＝平靜，越外圈越強烈；下方電池會跟著亮幾格。可以加備註，最近幾天的心情、走勢、月曆都看得到。',
      ...
      'howto.emotions.s2': '在情緒輪上拖到你現在的位置：中央＝平靜，6 個方向是不同情緒，越外圈越強烈；下方電池會跟著亮幾格，想多寫一些感受也可以打下來',
    ...
    'en': {
      ...
      'onb.s5.desc': "The top ring shows your latest mood. Drag on the emotion wheel — center = calm, outer = more intense; the battery below lights up 1–5 bars to match. Add a note (≤200 chars), submit, and find calendar + trend line + table below. Persistent low days flag for your doctor.",
      ...
      'howto.emotions.s2': 'Drag on the emotion wheel: center = calm, 6 directions are different emotions, outer rings = more intense. The battery below lights 1–5 bars to match. Add a short note (≤200 chars).',
