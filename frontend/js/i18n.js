...
(function () {
  const DICT = {
    'zh-TW': {
      ...
      'onb.s4.title': '藥物：拍一張，剩下交給我們',
      'onb.s4.desc': '把藥袋拍下來，藥名和劑量會自動填好，並依時段分成早、午、晚、睡前。時間到點一下就完成打卡。',
      ...
      'onb.s8.title': '隨時都能調整',
      'onb.s8.desc': '右上角可以切語言、深淺色、放大字。每一頁最上面都有「這頁怎麼用？」，看不懂的隨時打開。',
      ...
      'howto.meds.s3': '藥會自動分成早晨、中午、晚上、睡前；不分時段的（需要時才吃、或每幾小時一顆）放在「其他」',
      'howto.meds.s4': '時間到，點一下藥卡完成打卡。沒吃按 ✗、想記吃了之後的感覺按 ★、想看藥的說明按 ?',
    ...
    'en': {
      ...
      'onb.s8.desc': "Top-right toggles language (zh/en), light/dark, large-text (senior). In Settings you can replay this guide, tune notifications, export data. Every page has a 'How does this page work?' collapsible at the top.",
      ...
      'howto.meds.s3': 'The list auto-groups into morning / noon / evening / bedtime / other slots. "Other" is PRN or every-X-hours meds.',
      'howto.meds.s4': "When it's time, tap the card to mark taken; ✗ skip, ★ log effect/side effect, ? open drug encyclopedia.",
