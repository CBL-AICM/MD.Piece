...
(function () {
  const DICT = {
    'zh-TW': {
      ...
      'onb.s1.desc': '每一筆症狀、用藥、心情都是一個「碎片」，自動依時間範圍歸類（今天 / 本週 / 上次回診以來）。看診時直接給醫師看，不用臨時想破頭。',
      'onb.s2.title': '首頁：一天該記什麼，一眼看到',
      'onb.s2.desc': '首頁會數你今天打了幾個碎片（目標 6 個，達標後繼續加分），並列出今天該做的提醒。也可以自己加想記的小事。',
    ...
    'en': {
      ...
      'onb.s1.desc': "Every symptom, med dose and mood note is a 'piece', auto-sorted into time ranges (Today / This week / Since last visit). Visits go smoother with everything pre-organized. Eight quick steps cover the core features.",
      'onb.s2.title': 'Home: Today digest + To-do',
      'onb.s2.desc': "The orange hero counts how many pieces you've logged today (target: 6 — extras keep adding up). The 'Today's To-do' card lists system reminders (meds, visit countdown) plus anything you add yourself. ✓ marks done, 🗑 deletes.",
