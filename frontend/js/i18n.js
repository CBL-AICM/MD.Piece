...
(function () {
  const DICT = {
    'zh-TW': {
      ...
      'onb.s1.desc': '把每天的小碎片（症狀、用藥、情緒）拼起來，讓看診時更有頭緒。三步帶你看完。',
      'onb.s2.title': '想記什麼，從這邊開始',
      'onb.s2.desc': '桌機在左側欄、手機在底部中間有「+ 紀錄」鍵。功能依「紀錄／查詢／報告」分組，找不到時可用上方搜尋。',
      'onb.s3.title': '不順手隨時可以調',
      'onb.s3.desc': '右上角的設定可以切換語言、深淺色、放大字體（年長版）。引導之後也能在「系統設定」重新看。',
    ...
    'en': {
      ...
      'onb.s1.desc': 'Piece together your daily symptoms, meds and mood so visits go smoother. Three quick steps below.',
      'onb.s2.title': 'Where to start logging',
      'onb.s2.desc': "Use the left sidebar on desktop, or the '+ Record' button at the bottom on mobile. Features are grouped by Records / Search / Reports — search above if you can't find one.",
      'onb.s3.title': 'Tweak it any time',
      'onb.s3.desc': 'The top-right gear lets you switch language, light/dark mode, and senior mode (larger text). You can re-watch this guide from Settings.',
