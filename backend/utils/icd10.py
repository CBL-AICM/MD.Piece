...
CHRONIC_DISEASE_CATEGORIES = {
    ...
    "心血管疾病": ["I10", "I25", "I50", "I48", "I63", "I69"],
    "呼吸系統疾病": ["J45", "J44", "J30"],
    "消化系統疾病": ["K50", "K51", "K74", "K90"],
    "肌肉骨骼疾病": ["M06", "M05", "M81", "M10", "M11", "M79"],
    "自體免疫疾病": ["M32", "M35", "M45", "M34", "M33", "M31", "M30", "M07", "M02", "G70", "D69", "D68", "D86", "I73", "L52"],
    "皮膚與過敏疾病": ["L40", "L20", "L50", "J30", "L52"],
    "腎臟疾病": ["N18"],
    "神經退化疾病": ["G20", "G35", "G30", "G31", "G12"],
    "神經與感覺疾病": ["G40", "G43", "G45", "G50", "G61", "G62", "G47"],
    "精神疾病": ["F32", "F41"],
    "腫瘤追蹤": ["C50", "C34", "C18"],
}
...
COMORBIDITY_MAP: dict[str, list[str]] = {
    ...
    "I48": ["I10", "I50", "I25", "I63"],
    "I63": ["I10", "I48", "E11", "E78", "I25", "I69"],
    "I69": ["I63", "I10", "F32", "G30", "G45"],
    # 氣喘、COPD — 互相鑑別、合併情形多；過敏三聯徵：J45 / J30 / L20 / L50 常合併
    "J45": ["J44", "F41", "J30", "L20", "L50"],
    "J44": ["J45", "I50", "I25", "I10"],
    # 發炎性腸道疾病、肝硬化、乳糜瀉
    "K50": ["K51", "M06", "M45", "M07", "M02", "L52"],
    "K51": ["K50", "M06", "M45", "M07", "M02", "L52"],
    "K74": ["E11", "E78", "M34"],
    "K90": ["E03", "M32", "E10"],
    ...
    "M32": ["M35", "M06", "N18", "F32", "M81", "D68", "I73", "M30"],
    "M35": ["M32", "M06", "F32", "M79"],
    "M45": ["K50", "K51", "L40", "M06", "M07", "M02"],
    "M34": ["I50", "N18", "K74", "F32", "I73"],
    "M33": ["M32", "C50", "C34", "F32", "I73"],
    "M31": ["F32", "M32", "M30", "L52"],
    "M30": ["M31", "M32", "L52"],
    "M07": ["L40", "M45", "M02", "K50", "K51"],
    "M02": ["M45", "M07", "K50", "K51"],
    "M10": ["E11", "I10", "E78", "N18", "M81"],
    "M11": ["M10", "M81", "M06"],
    "M79": ["F32", "F41", "M06", "M32", "G47"],
    "D68": ["M32", "I63", "I50", "I48"],
    "D86": ["J44", "M81", "F32", "M31"],
    "I73": ["M34", "M32", "M35", "M33"],
    "L52": ["K50", "K51", "M30", "M31"],
